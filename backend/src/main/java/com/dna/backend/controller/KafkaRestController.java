...
@RestController
@RequestMapping("/restkafka")
public class KafkaRestController {

	/**
	 * Kafka Controller class for requestmapping of kafkaproducer and kafkaconsumer
	 * services
	 * 
	...
	/**
	 * injecting UserRepository for calling methods used to find different
